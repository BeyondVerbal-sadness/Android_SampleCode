...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    private static final String RECORDING_URL = "https://saddetector.beyondverbal.com/v4/recording/";
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                try {
                    ...
                    //int id = value2.getJSONObject("Mood").getJSONObject("Composite").getJSONObject("Primary").getInt("Id");
                    String kaka = value2.getJSONObject("Mood").getJSONObject("Composite").getJSONObject("Primary").getString("Phrase");

                    //Log.i("idddddd", ""+id);
                    Log.i("Composite", kaka);
                } catch (JSONException e) {

                }

                //JSONObject mood = value2.getJSONObject("Arousal");
            ...
            String stop = "";
            //JSONArray jsonArray = json.getJSONArray("analysisSegments");

            // int size = jsonArray.length();


//			responseHand = gson.fromJson(json2, ResponseHandler.class);
//            int size = responseHand.getAnalysisSegments().size();
//            for (int i = 0; i< responseHand.getAnalysisSegments().size(); i++){
//                if(responseHand.getAnalysisSegments().get(i).getAnalysis().getMood() != null){
//                    String composite = responseHand.getAnalysisSegments().get(0).getAnalysis().getMood().getComposite().getPrimary().getPhrase();
//                    String group7 = responseHand.getAnalysisSegments().get(0).getAnalysis().getMood().getGroup7().getPrimary().getPhrase();
//                }
//            }
